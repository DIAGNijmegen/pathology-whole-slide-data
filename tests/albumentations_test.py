from wholeslidedata.interoperability.albumentations.callbacks import AlbumentationsSegmentationAugmentationsCallback
import numpy as np
...
def test_albumentation_callback():
    ...
    aug = AlbumentationsSegmentationAugmentationsCallback(augmentations=augmentations)
    ...
    y_target = SegmentationPatchLabelSampler().sample(wsa, point=point.geometry, size=(284, 284), ratio=1)
    y_context = SegmentationPatchLabelSampler().sample(wsa, point=point.geometry, size=(284, 284), ratio=8)
